...
class Leven {
  ...
  async HDWallet({ mnemonic, address_index, num_addresses, options }) {
    let wallet_hdpath =
      typeof options.wallet_hdpath != 'undefined' ? options.wallet_hdpath : "m/44'/60'/0'/0/";
